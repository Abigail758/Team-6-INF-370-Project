...
import { AddPhaseStatusComponent } from '../add-phase-status/add-phase-status.component';
import { UpdatePhaseStatusComponent } from '../update-phase-status/update-phase-status.component';

@Component({
  selector: 'app-list-phase-statuses',
  templateUrl: './list-phase-statuses.component.html',
  styleUrls: ['./list-phase-statuses.component.scss']
})
export class ListPhaseStatusesComponent implements OnInit {
  displayedColumns: string[] = ['name', 'description', 'actions'];
  dataSource: any;
  listOfRecords: PhaseStatus[] = [];
  record: PhaseStatus;
  ...
  onAddNew() {
    let dialogRef = this._dialog.open(AddPhaseStatusComponent, {
      width: "50%",
      height: "auto"
    });
  ...
  onUpdateRecord(record: PhaseStatus) {
    let dialogRef = this._dialog.open(UpdatePhaseStatusComponent, {
      width: "50%",
      height: "auto",
      data: {
