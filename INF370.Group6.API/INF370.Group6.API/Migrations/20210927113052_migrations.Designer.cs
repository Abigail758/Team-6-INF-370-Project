...
namespace INF370.Group6.API.Migrations
{
    ...
    [Migration("20210927113052_migrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Supplier.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Suppliers.SupplierType", b =>
                {
                    b.Property<int>("SupplierTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SupplierTypeId1")
                        .HasColumnType("int");

                    b.HasKey("SupplierTypeId");

                    b.HasIndex("SupplierTypeId1");
            ...
            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Tenders.Tender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Tenders.TenderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Supplier.Supplier", b =>
                {
                    b.HasOne("INF370.Group6.API.Layers.Core.Suppliers.SupplierType", "SupplierTypes")
                        .WithMany()
                        .HasForeignKey("SupplierTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SupplierTypes");
                });

            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Suppliers.SupplierType", b =>
                {
                    b.HasOne("INF370.Group6.API.Layers.Core.Suppliers.SupplierType", null)
                        .WithMany("SupplierTypes")
                        .HasForeignKey("SupplierTypeId1");
                });
            ...
            modelBuilder.Entity("INF370.Group6.API.Layers.Core.Tenders.Tender", b =>
                {
                    b.HasOne("INF370.Group6.API.Layers.Core.Tenders.TenderStatus", "Tenders")
                        .WithMany("Tenders")
