...
namespace INF370.Group6.API.Migrations
{
    ...
    [Migration("20211012221241_EquipmentModels")]
    partial class EquipmentModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipmentTask", b =>
                {
            ...
            modelBuilder.Entity("EquipmentTask", b =>
                {
                    b.HasOne("INF370.Group6.API.Layers.Core.Equipments.Equipment", null)
                        .WithMany()
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("INF370.Group6.API.Layers.Core.Tasks.Task", null)
                        .WithMany()
